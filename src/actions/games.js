  ...
  return function(dispatch) {
    ...
    selectedSkills.forEach((skill) => {
      if (skill.gameIds) {
        ...
        let noGames = [ { _id: "no_games_for_the_chosen_skills", name: "Our Apologies", description: "Unfortunately, we do not currently have any games for the skills you selected.", bonus: "We hope to have new games added for you soon." } ];
